...
export function detectImageIssues(images) {
    const issues = [];
...
export async function generateAltText(input, ai) {
    try {
...
function extractAltFromCode(code) {
...
export async function convertToAVIF(buffer, options = {}) {
...
export function generateResponsiveSizes(originalWidth) {
